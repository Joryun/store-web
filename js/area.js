...
for (var i = 0; i < area.length; i++) {
    for (var j = 0; j < area[i].sub.length; j++) {
        if (area[i].sub[j].sub) delete area[i].sub[j].sub;
    }
}
 ...
 */
const amendArea = (list = [], labelAttr = 'label', valueAttr = 'value', childAttr = 'children') => {
    let item = null,
        temp = {},
        result = [],
        subChildren = null;
